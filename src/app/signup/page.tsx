    ...
    <main className="bg-gray-50 min-h-screen">
      ...
      <div className="w-full px-4 md:px-8 lg:px-16 py-8 md:py-16">
        <div className="max-w-md mx-auto">
          ...
          {/* SIGN UP Heading */}
          <h1 className="text-3xl font-bold text-black mb-2 uppercase">SIGN UP</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="firstName" className="block text-sm font-normal text-black mb-2 uppercase">
                  First Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-normal text-black mb-2 uppercase">
                  Last Name
                </label>
                <input
                  type="text"
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-sm font-normal text-black mb-2 uppercase">
                Password
              </label>
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 pr-12 border bg-white text-black text-sm font-normal focus:outline-none transition-colors ${
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-normal text-black mb-2 uppercase">
                Confirm Password
              </label>
              <div className="relative">
                <input
            ...
            <div>
              <label className="flex items-start">
                ...
                <span className="ml-2 text-sm text-gray-600">
                  I agree to the{' '}
                  <Link href="/terms" className="text-black hover:opacity-70 transition-opacity underline">
                    Terms of Service
                  </Link>
                  {' '}and{' '}
                  <Link href="/privacy" className="text-black hover:opacity-70 transition-opacity underline">
                    Privacy Policy
                  </Link>
                </span>
              </label>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="text-black font-normal hover:opacity-70 transition-opacity underline">
                Sign in
              </Link>
            </p>
          </div>
          ...
          <div className="mt-8 space-y-4">
            <button
              type="button"
              className="w-full py-3 border border-gray-300 bg-white text-black text-sm font-normal hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
